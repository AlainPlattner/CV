...
\spcp \textbf{A.M.~Plattner} and C.L.~Johnson. Local spherical harmonic power spectra from local magnetic or gravity data. \emph{Geophys.~J.~Int.} in review

\spcp C.\ Wu, C.\ Lu, Y.\ Chen, \textbf{A.\ Plattner}, B.\ Liu, L.\ Shu, Y.\ Zhang. Anomalous Decline of Groundwater Levels in Coastal Aquifers in China Identified by Combining GRACE and InSAR Data. \emph{Geophys.~Res.~Lett.}, in review

\spcp \textbf{A.M.~Plattner}, A.C. Mills, C.L.~Johnson, M.J. Styczinski, and
S.D. Vance. How well do pesent data constrain Ganymede's core
